...
### Версия 1.1.0 - Исправления для продакшена
...
1. **Ошибка базы данных SQLite**
   ...
   - **Решение:** 
     - Добавлена инициализация БД в `wsgi.py`
...
**docker-compose.yml:**
```yaml
# Правильное монтирование БД
volumes:
  - ./loans.db:/app/loans.db:rw
```
...
**Дата:** 2025  
**Последнее обновление:** Исправления для продакшена (SQLite + статические файлы)